...
public class ProductoService {
    ...
    public List<Producto> buscarPorFiltro(String categoria,String marca,String condition){
        return productoRepository.buscarPorFiltro(categoria,marca,condition);
    }
