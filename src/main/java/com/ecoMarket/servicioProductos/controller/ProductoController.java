...
public class ProductoController {
    ...
    public ResponseEntity<List<Producto>> listar(
        ...
        productCondition = "".equals(productCondition) ? null : productCondition;

        if(categoria == null && marca == null && productCondition == null){
            productos = productoService.findAll();
        }
        else {
            productos = productoService.buscarPorFiltro(categoria,marca, productCondition);
        }
